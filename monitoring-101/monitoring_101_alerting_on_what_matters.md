...
*This post is part of a series on effective monitoring. Be sure to check out the rest of the series: [Collecting the right data](https://github.com/DataDog/the-monitor/blob/master/monitoring-101/monitoring_101_collecting_the_right_data.md) and [Investigating performance issues](https://github.com/DataDog/the-monitor/blob/master/monitoring-101/monitoring_101_investigating_performance_issues.md).
