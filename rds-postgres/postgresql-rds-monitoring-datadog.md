...
{{< img src="postgresql-rds-monitoring-data-aws-tile.png" alt="PostgreSQL RDS monitoring data collection through Datadog integration" popup="true" border="true" >}}
...
{{< img src="postgresql-rds-monitoring-metric-comparison.png" alt="postgresql dashboard" border="true" popup="true" >}}
...
{{< img src="postgresql-rds-monitoring-postgresql-custom-metric.png" alt="postgresql dashboard" border="true" >}}
...
{{< img src="postgresql-rds-monitoring-screenboard-2.png" alt="RDS PostgreSQL data in Datadog's out-of-the-box screenboard" border="true" popup="true" >}}
...
{{< inline-cta text="Use Datadog's detailed flame graphs to visualize RDS request traces." btn-text="Get started" data-event-category="Signup" signup="true" >}}
...
{{< img src="postgresql-rds-monitoring-data-service-dash2.png" alt="PostgreSQL RDS monitoring data - Datadog's out-of-the-box service-level dashboard" border="true" >}}

On the [App Analytics][dd-trace-search] page, you can inspect individual request traces in detailed flame graphs that show the amount of time spent accessing various services throughout our environment. In the request below, we can see that the application is making several calls to the RDS database, and that it spends a small amount of time in Redis. We can dig deeper by clicking on any individual span to view more information, such as the exact SQL query that was executed.

{{< img src="postgresql-rds-monitoring-data-flamegraph-pg-query.png" alt="PostgreSQL RDS monitoring - data flame graph inspect query" popup="true" border="true" >}}
...
{{< img src="postgresql-rds-monitoring-combo-dashboard.png" alt="PostgreSQL RDS monitoring - custom dashboard with EC2 and app-level metrics" border="true" popup="true" >}}
...
{{< img src="postgresql-rds-monitoring-data-storage-forecast-2.png" alt="PostgreSQL RDS monitoring - forecast free storage in Datadog" popup="true" border="true" >}}
...
[rds-enhanced-dashboard]: https://app.datadoghq.com/dash/integration/65/aws-rds-enhanced-metrics
...
[dd-agent-config]: https://docs.datadoghq.com/agent/guide/agent-configuration-files/
